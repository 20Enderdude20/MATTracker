function [k, period] = waveselect1(noise_freq_divide, t, noisetable, width, wavetype, fourier, ring, vol)
    period = t;
    if wavetype == 1
        k = vol*pulsewave1(t, width, fourier); %This version has no DC offset.
        period = mod(t, 2*pi);
        return
    elseif wavetype == 2
